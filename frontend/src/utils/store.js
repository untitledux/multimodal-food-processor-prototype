  ...
  recipes: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_2_1_sucess_4KHrLL2WDT.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_3_OPhF79UEn3.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_5_ziVjFaGrWi.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_6_aWtna9V_eh.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_8_I2TosV5pHX.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_9_7EJNkoHqOKFr.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
        ...
        },
        {
          ...
          cp: RecipesSteps,
          url: 'https://ik.imagekit.io/nuicookit/RECIPE_STEP_10_6_oGwq1z5O.png',
          active: false,
          clickableOverlay: {
            overlay: 'clickOverlay2',
            next: {
